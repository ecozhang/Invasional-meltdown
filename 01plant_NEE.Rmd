...
p1 <- plot_alone(dat_lambda_root, variable = 'root', 
  ...
  annotate("text", x = 5, y = 2, label = expression(Soil[Non-conditioned/Conditioned] ~ '*'), hjust = 0, size = 2.5) +
  annotate("text", x = 5, y = 1.8, label = expression(Soil[Home/Away] ~ '\u2020'), hjust = 0, size = 2.5) +
  annotate("text", x = 5, y = 1.6, label = expression(Origin : Soil[Home/Away] ~ '*'), hjust = 0, size = 2.5) +
  annotate("text", x = 5, y = 1.4, label = expression(Origin : Soil[Alien/Native] ~ '\u2020'), hjust = 0, size = 2.5) 

# total
p2 <- plot_alone(dat_lambda_total, variable = 'total', 
                 ylab = 'Total biomass [g]\n', ylim = c(0,5),
                 tag = 'b', legend = F) +   
  annotate("text", x = 5, y = 5, label = expression(Soil[Non-conditioned/Conditioned] ~ '*'), hjust = 0, size = 2.5) +
  annotate("text", x = 5, y = 4.5, label = expression(Origin : Soil[Alien/Native] ~ '*'), hjust = 0, size = 2.5) 
